	...
	?>
			<div class="userpro-admin-head">
				<div class="userpro-admin-left">
					...
					<span class="userpro-admin-span"><?php if (get_option('userpro_activated')) { _e('Thank you for activating UserPro!','userpro'); } else { _e('Thank you for activating UserPro! SHARED ON WPLOCKER.COM','userpro'); } ?></span>
				</div>
