...
$monarch_options_all = array(
							...
							'display_settings' => array(
													...
													'auto_popup' => array(
																		'type' => 'checkbox',
																		'title' => __( 'Enable Automatic Pop Up', 'Monarch' ),
																		'title_flyin' => __( 'Enable Automatic Flyin', 'Monarch' ),
																		'name' => 'auto_popup',
													...
													'trigger_leave' => array(
																			'type' => 'checkbox',
																			'title' => __( 'Trigger on Page Leave', 'Monarch' ),
																			'name' => 'trigger_leave',
																			'default' => false,
																		),
													'trigger_bottom' => array(
																			'type' => 'checkbox',
																			'title' => __( 'Trigger at Bottom of Post', 'Monarch' ),
																			'name' => 'trigger_bottom',
																			'default' => false,
																			'default_flyin' => true,
																		),
...
$sharing_popup_options = array(
								...
								$monarch_options_all[ 'display_settings' ][ 'section_start' ],
									...
									$monarch_options_all[ 'display_settings' ][ 'trigger_leave' ],
