	...
	?>
			<div class="userpro-admin-head">
				<div class="userpro-admin-left">
					...
					<span class="userpro-admin-span"><?php if (get_option('userpro_activated')) { _e('Thank you for activating UserPro!','userpro'); } else { _e('Thank you for activating UserPro - WPLOCKER NULLED','userpro'); } ?></span>
				</div>
				<div class="userpro-admin-right">
					...
					<a href="http://bestblackhatforum.com/Thread-GET-Always-Updated-UserPro-User-Profiles-with-Social-Login-v-2-3-Latest" class="button button-primary"><?php _e('Download Latest','userpro'); ?></a>
				</div>
				<div class="clear"></div>
			</div>
	<?php
