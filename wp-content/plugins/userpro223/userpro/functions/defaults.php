<?php
	...
	function userpro_default_options(){
		...
		$array['hidden_from_view'] = 'display_name,profilepicture,facebook,twitter,google_plus,user_email,user_url,phone_number,custom_profile_color,custom_profile_bg,securityqa';
		...
		$array['userpro_invite_emails_template'] = 'You are invited <a href="{inivitelink}">. Click here to register</a>';
